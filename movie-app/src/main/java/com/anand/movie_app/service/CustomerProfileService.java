...
import com.anand.movie_app.entity.CustomerProfile;
import com.anand.movie_app.repository.CustomerProfileRepository;
...
public class CustomerProfileService {
    ...
    public List<CustomerProfile> findByFullNameContaining(String keyword) {
        return repository.findByFullNameContaining(keyword);
    }
